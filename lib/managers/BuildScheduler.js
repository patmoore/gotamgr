...
BuildSchedulerType = ManagerType.createSubClass('buildScheduler',
    [
    ...
    ],
    {
        currentBuildOrderCursor: function() {
            ...
            return BuildRequest.databaseTable.findByUserId(userId);
        }
    },
    BuildRequest,
    null,
    {
        ...
        /**
         *
         * @param buildRequest object with key : quantity needed.
         */
        needCalculate: function(buildRequest, inventory, depth) {
         ...
         * @param inventory
         */
        schedule : function(buildRequest, inventory) {
            if ( typeof(leadTime) ==="undefined") {
                leadTime = 0;
            }
            var buildingPlan = {};

            this._createBuildOrders(buildingPlan, buildRequest, null);
         ...
         * @private
         */
        _createBuildOrders : function(buildingPlan, buildRequest, dependentBuildOrder) {
