            ...
            "get" : function() {
                ...
                if ( this.componentBuildOrders) {
                    for(var i = 0; i < this.componentBuildOrders.length; i++) {
                        ...
                        var buildableKey = buildOrder.buildable;
                        var stockable = getInventoryEnum(buildableKey);
                        var buildingKey = stockable.buildings ? stockable.buildings[0] : null;
                        if ( buildingKey == null) {
                            continue;
