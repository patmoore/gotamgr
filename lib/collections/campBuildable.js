...
Meteor.startup(function(){
    ...
    for(i = 0; i < 21; i++) {
        ...
        case 6:
            ...
            organize(intrigue, i, Buildables.eavesdropper, 1);
            organize(intrigue, i, Buildables.fingerless_gloves, 1);
            organize(intrigue, i, Buildables.linen_clothing, 1);
            break;
        case 7:
            //6h
            organize(battle, i, Buildables.silver, 1);
            ...
            organize(intrigue, i, Buildables.silver, 10000);
            organize(intrigue, i, Buildables.turtle, 1);
            organize(intrigue, i, Buildables.roughspun_cloak, 1);
            organize(intrigue, i, Buildables.linen_clothing, 1);
            break;
        case 8:
            ...
            organize(intrigue, i, Buildables.eavesdropper, 1);
            organize(intrigue, i, Buildables.turtle, 1);
            organize(intrigue, i, Buildables.red_gem, 1);
            break;
        case 9:
            //8h
            organize(battle, i, Buildables.silver, 1);
            ...
            organize(intrigue, i, Buildables.silver, 10000);
            organize(intrigue, i, Buildables.turtle, 1);
            organize(intrigue, i, Buildables.milk_of_the_poppy, 1);
            organize(intrigue, i, Buildables.fingerless_gloves, 1);
            break;
        case 10:
            //9h
        ...
        case 11:
            ...
            organize(battle, i, Buildables.silver, 1);
            organize(battle, i, Buildables.ram, 1);
            organize(battle, i, Buildables.splint_mail, 1);
