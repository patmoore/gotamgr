    ...
    for(i = 0; i < 21; i++) {
        ...
        case 0:
            ...
            _.each(SkillGeneral.symbols(), function(skillGeneral) {
                organize(skillGeneral, i, Buildables.cloth, 20);
                organize(skillGeneral, i, Buildables.grains, 10);
                organize(skillGeneral, i, Buildables.smallfolk, 10);
            });
            break;
        case 1:
            //1h
            _.each(SkillGeneral.symbols(), function(skillGeneral) {
                organize(skillGeneral, i, Buildables.wood, 30);
                organize(skillGeneral, i, Buildables.fur, 30);
                organize(skillGeneral, i, Buildables.horse, 20);
            });
            break;
        ...
        case 2:
            //1h
            _.each(SkillGeneral.symbols(), function(skillGeneral) {
                organize(skillGeneral, i, Buildables.stone, 40);
                organize(skillGeneral, i, Buildables.ore, 40);
                organize(skillGeneral, i, Buildables.fish, 30);
            });
            break;
...
//            organize(intrigue, i, Buildables.red_gem, 7);
            organize(battle, i, Buildables.red_gem, 10);
            organize(battle, i, Buildables.special_1, 6);
            organize(battle, i, Buildables.special_2, 3);

            organize(trade, i, Buildables.red_gem, 10);
            organize(trade, i, Buildables.special_3, 6);
            organize(trade, i, Buildables.special_4, 3);

            organize(intrigue, i, Buildables.red_gem, 10);
            organize(intrigue, i, Buildables.special_5, 6);
            organize(intrigue, i, Buildables.special_6, 3);
            break;
        case 4:
            // 3h
...
//            organize(intrigue, i, Buildables.decorative_blade, 1);
            organize(battle, i, Buildables.blue_gem, 10);
            organize(battle, i, Buildables.special_1, 11);
            organize(battle, i, Buildables.special_2, 5);

            organize(trade, i, Buildables.blue_gem, 10);
            organize(trade, i, Buildables.special_3, 11);
            organize(trade, i, Buildables.special_4, 5);

            organize(intrigue, i, Buildables.blue_gem, 10);
            organize(intrigue, i, Buildables.special_5, 11);
            organize(intrigue, i, Buildables.special_6, 5);
            break;
        case 5:
            //4h
...
//            organize(intrigue, i, Buildables.roughspun_cloak, 1);
            organize(battle, i, Buildables.special_1, 12);
            organize(battle, i, Buildables.special_2, 6);
            organize(battle, i, Buildables.special_7, 3);

            organize(trade, i, Buildables.special_3, 12);
            organize(trade, i, Buildables.special_4, 6);
            organize(trade, i, Buildables.special_7, 3);

            organize(intrigue, i, Buildables.special_5, 12);
            organize(intrigue, i, Buildables.special_6, 6);
            organize(intrigue, i, Buildables.special_7, 3);
            break;
        case 6:
            //5h
//            organize(battle, i, Buildables.silver, 1);
...
//            organize(intrigue, i, Buildables.linen_clothing, 15);
            organize(battle, i, Buildables.special_1, 20);
            organize(battle, i, Buildables.special_2, 10);
            organize(battle, i, Buildables.special_8, 5);

            organize(trade, i, Buildables.special_3, 20);
            organize(trade, i, Buildables.special_4, 10);
            organize(trade, i, Buildables.special_8, 5);

            organize(intrigue, i, Buildables.special_5, 20);
            organize(intrigue, i, Buildables.special_6, 10);
            organize(intrigue, i, Buildables.special_8, 5);
            break;
        case 7:
            //6h
//            organize(battle, i, Buildables.silver, 1);
...
//            organize(intrigue, i, Buildables.linen_clothing, 33);
            organize(battle, i, Buildables.ladder, 20);
            organize(battle, i, Buildables.special_2, 22);
            organize(battle, i, Buildables.special_7, 10);

            organize(trade, i, Buildables.trebuchet, 20);
            organize(trade, i, Buildables.special_4, 22);
            organize(trade, i, Buildables.special_7, 10);

            organize(intrigue, i, Buildables.turtle, 20);
            organize(intrigue, i, Buildables.special_6, 22);
            organize(intrigue, i, Buildables.special_7, 10);
            break;
        case 8:
            //7h
//            organize(battle, i, Buildables.silver, 1);
...
//            organize(intrigue, i, Buildables.red_gem, 37);
            organize(battle, i, Buildables.ladder, 25);
            organize(battle, i, Buildables.special_3, 30);
            organize(battle, i, Buildables.special_8, 15);

            organize(trade, i, Buildables.trebuchet, 25);
            organize(trade, i, Buildables.special_5, 30);
            organize(trade, i, Buildables.special_8, 15);

            organize(intrigue, i, Buildables.turtle, 25);
            organize(intrigue, i, Buildables.special_3, 30);
            organize(intrigue, i, Buildables.special_8, 15);
            break;
        case 9:
            //8h
//            organize(battle, i, Buildables.silver, 1);
...
//            organize(intrigue, i, Buildables.fingerless_gloves, 30);
            organize(battle, i, Buildables.ladder, 30);

            organize(trade, i, Buildables.trebuchet, 25);

            organize(intrigue, i, Buildables.turtle, 25);
            _.each(SkillGeneral, function(skillGeneral) {
                organize(skillGeneral, i, Buildables.special_7, 14);
                organize(skillGeneral, i, Buildables.special_8, 22);
            });
            break;
        case 10:
            //9h
