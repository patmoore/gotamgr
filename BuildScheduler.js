 ...
 */
BuildScheduler.prototype.schedule = function(build_request, inventory) {
    'use strict';
    var that = this;
...
BuildScheduler.prototype.buildIt = function(build_request, inventory) {

}
BuildScheduler.prototype.cloneIt = function(object) {
    var cloned = JSON.parse(JSON.stringify(object));
    return cloned;
}

BuildScheduler.prototype.addTo = function(object, key, value) {
